...
//     const ganglionButton = useRef();
//     const disconnectButton = useRef();

//     useEffect(() => {
// 		// Set button functionality
// 		if(ganglionButton.current && disconnectButton.current){
// 			ganglionButton.current.onClick = () => {rec=true;console.log(rec);startAcquisition(ganglionButton.current.id)};
// 			disconnectButton.current.onClick = () => {rec=false;console.log("I GOT CLICKED " + rec)};	
// 		}
//        },[ganglionButton, disconnectButton])



// 	const MidiElement = useCallback(() =>
// 		<> 
// 		<div id="buttons">
// 		  <button id="ganglion" ref={ganglionButton} className="recordButton">
// 			RECORD
// 		  </button>
// 		  <button id="Disconnect" ref={disconnectButton} className="stopButton" onClick={generateAndDownloadMIDIFile}>
// 			STOP
// 		  </button>
// 		</div>
