...
router.post('/createUser', async (req, res) => {
    try {
        ...
        const userEmailExists = dbUtil.getUserExists(email, "email");

        const userNameExists = dbUtil.getUserExists(username, "username");
...
router.post('/loginUser', async (req, res) => {
    try {
        ...
        const userExists = dbUtil.getUserExists(email, "email");
...
router.get('/getUserByUsername', async (req, res) => {
    try {
        const userExists = dbUtil.getUserExists(req.query.username, "username");
...
router.get('/getUserByID', async (req, res) => {
    try {
        const userExists = dbUtil.getUserExists(req.query.id, "id");
...
router.put('/updateUser', upload.single('profilePicture'), async (req, res) => {
    try{
        ...
        const userExists = dbUtil.getUserExists(id, "id");
